VERSION 5.00
Begin VB.Form frmJuristicNonResident 
   BackColor       =   &H00BFD87E&
   Caption         =   "Non-Resident Juristic Customer Details"
   ClientHeight    =   8760
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   12060
   ...
   Begin VB.Frame FrameSamaAuthInfo 
      ...
      End
   End
   Begin VB.Frame FrameContractInfo 
      BackColor       =   &H00BFD87E&
      BorderStyle     =   0  'None
      Height          =   435
      Left            =   120
      ...
      Top             =   960
      Width           =   11700
      Begin VB.TextBox txtContractIssueYear 
         BackColor       =   &H00FFFFFF&
         Height          =   285
         Left            =   7995
         MaxLength       =   4
         ...
         Width           =   555
      End
      Begin VB.ComboBox cmbContractIssueMonth 
         BackColor       =   &H00FFFFFF&
         Height          =   315
         Left            =   7395
         TabIndex        =   6
         ...
         Width           =   615
      End
      Begin VB.ComboBox cmbContractIssueDate 
         BackColor       =   &H00FFFFFF&
         Height          =   315
         Left            =   6840
         TabIndex        =   5
         ...
         Width           =   615
      End
      Begin VB.ComboBox cmbContractExpiryDate 
         BackColor       =   &H00FFFFFF&
         Height          =   315
         Left            =   9720
         TabIndex        =   8
         ...
         Width           =   615
      End
      Begin VB.ComboBox cmbContractExpiryMonth 
         BackColor       =   &H00FFFFFF&
         Height          =   315
         Left            =   10350
         TabIndex        =   9
         ...
         Width           =   615
      End
      Begin VB.TextBox txtContractExpiryYear 
         BackColor       =   &H00FFFFFF&
         Height          =   285
         Left            =   10950
         MaxLength       =   4
      ...
      Begin VB.Frame Frame2 
         ...
         Top             =   -90
         Width           =   1515
         Begin VB.OptionButton optContractDateGreg 
            BackColor       =   &H00BFD87E&
            Caption         =   "Greg"
            Height          =   195
            Left            =   720
            ...
            Width           =   735
         End
         Begin VB.OptionButton optContractDateHijri 
            BackColor       =   &H00BFD87E&
            Caption         =   "Hijri"
            Height          =   255
            Left            =   135
         ...
         End
      End
      Begin VB.Label lblContractIssueDate 
         AutoSize        =   -1  'True
         BackColor       =   &H00BFD87E&
         Caption         =   "Issue Date"
         BeginProperty Font 
         ...
         Width           =   1170
      End
      Begin VB.Label lblContractDateType 
         AutoSize        =   -1  'True
         BackColor       =   &H00BFD87E&
         Caption         =   "Date Type"
         BeginProperty Font 
         ...
         Width           =   900
      End
      Begin VB.Label lblContractExpiryDate 
         AutoSize        =   -1  'True
         BackColor       =   &H00BFD87E&
         Caption         =   "Expiry Date"
         BeginProperty Font 
   ...
   Begin VB.Line Line6 
      ...
      Y2              =   6240
   End
   Begin VB.Label lblNonResJuristicCustDetails 
      AutoSize        =   -1  'True
      BackColor       =   &H00BFD87E&
      Caption         =   "Non-Resident Juristic Customer Details"
      BeginProperty Font 
   ...
   End
End
Attribute VB_Name = "frmJuristicNonResident"
...
Private Sub cmbContractExpiryDate_Change()
   If Not supervisorAction And Not searchAction And Not custHistoryAction Then
      If Len(RTrim(cmbContractExpiryDate.text)) <> 0 Then
         If Len(cmbContractExpiryDate) = 2 Then
            If cmbContractExpiryDate < 1 Or _
               cmbContractExpiryDate > IIf(optContractDateGreg.Value = True, 31, 30) Then
               MsgBox errEnterValidDate(UserLang) '"Enter a valid Date"
               cmbContractExpiryDate.text = ""
               cmbContractExpiryDate.SetFocus
            Else
               On Error Resume Next
               cmbContractExpiryMonth.SetFocus
            End If
         End If
      End If
   End If
...
Private Sub cmbContractExpiryDate_KeyPress(KeyAscii As Integer)
If (KeyAscii < 48 Or KeyAscii > 57) And KeyAscii <> 8 Then
      KeyAscii = 0
      MsgBox (errOnlyNumeralsAllowed(UserLang))
      Exit Sub
...
Private Sub cmbContractExpiryMonth_Change()
  If Not supervisorAction And Not searchAction And Not custHistoryAction Then
      If Len(RTrim(cmbContractExpiryMonth.text)) <> 0 Then
         If Len(cmbContractExpiryMonth.text) = 2 Then
            If cmbContractExpiryMonth < 1 Or cmbContractExpiryMonth > 12 Then
               MsgBox errEnterValidMonth(UserLang) '"Enter a valid Month"
               cmbContractExpiryMonth.text = ""
               cmbContractExpiryMonth.SetFocus
            Else
               On Error Resume Next
               txtContractExpiryYear.SetFocus
            End If
         End If
      End If
   End If
...
Private Sub cmbContractExpiryMonth_KeyPress(KeyAscii As Integer)
  If (KeyAscii < 48 Or KeyAscii > 57) And KeyAscii <> 8 Then
      KeyAscii = 0
      MsgBox (errOnlyNumeralsAllowed(UserLang))
      Exit Sub
...
Private Sub cmbContractIssueDate_Change()
   If Not supervisorAction And Not searchAction And Not custHistoryAction Then
      If Len(RTrim(cmbContractIssueDate.text)) <> 0 Then
         If Len(cmbContractIssueDate.text) = 2 Then
            If cmbContractIssueDate < 1 Or _
               cmbContractIssueDate > IIf(optContractDateGreg.Value = True, 31, 30) Then
               MsgBox errEnterValidDate(UserLang) '"Enter a valid Date"
               cmbContractIssueDate.text = ""
               cmbContractIssueDate.SetFocus
            Else
               On Error Resume Next
               cmbContractIssueMonth.SetFocus
            End If
         End If
      End If
   End If
...
Private Sub cmbContractIssuedate_KeyPress(KeyAscii As Integer)
  If (KeyAscii < 48 Or KeyAscii > 57) And KeyAscii <> 8 Then
      KeyAscii = 0
      MsgBox (errOnlyNumeralsAllowed(UserLang))
      Exit Sub
...
Private Sub cmbContractIssueMonth_Change()
   If Not supervisorAction And Not searchAction And Not custHistoryAction Then
      If Len(RTrim(cmbContractIssueMonth.text)) <> 0 Then
         If Len(cmbContractIssueMonth.text) = 2 Then
            If cmbContractIssueMonth < 1 Or cmbContractIssueMonth > 12 Then
               MsgBox errEnterValidMonth(UserLang) '"Enter a valid Month"
               cmbContractIssueMonth.text = ""
               cmbContractIssueMonth.SetFocus
            Else
               On Error Resume Next
               txtContractIssueYear.SetFocus
            End If
         End If
      End If
   End If
...
Private Sub cmbContractIssueMonth_KeyPress(KeyAscii As Integer)
  If (KeyAscii < 48 Or KeyAscii > 57) And KeyAscii <> 8 Then
      KeyAscii = 0
      MsgBox (errOnlyNumeralsAllowed(UserLang))
      Exit Sub
...
Private Sub cmdNextPage_Click()
  ...
  If Not supervisorAction And Not searchAction And Not custHistoryAction Then
     If validateFrmJuristicNonResident = 1 Then
        Exit Sub
     End If
     ...
     tIdType = Space(1)
     tIdNo = Space(15)
     If Len(RTrim(frmJuristicNonResident.txtContractNo)) > 0 Then
        tIdType = "T"
        tIdNo = Format(frmJuristicNonResident.txtContractNo, "!@@@@@@@@@@@@@@@")
     ElseIf Len(RTrim(frmJuristicNonResident.txtLicNo)) > 0 Then
        tIdType = "L"
        tIdNo = Format(frmJuristicNonResident.txtLicNo, "!@@@@@@@@@@@@@@@")
     End If
     ...
     If checkCustomerExistance(frmJuristicNonResident, tIdType, tIdNo, newOrUpdate, tCustNo, custName) = 1 Then
...
Private Sub Form_Load()
    ...
    If UserLang = ARABIC Then
       ChangePositions frmJuristicNonResident, 11800
       frmJuristicNonResident.RightToLeft = True
   ...
   frmJuristicNonResident.Caption = frmJuristicNonResidentCaption(0, UserLang)
   lblNonResJuristicCustDetails.Caption = frmJuristicNonResidentCaption(0, UserLang)
   ...
   lblContractNo.Caption = frmJuristicNonResidentCaption(1, UserLang)
   lblContractDateType.Caption = frmJuristicNonResidentCaption(2, UserLang)
   optContractDateHijri.Caption = frmJuristicNonResidentCaption(3, UserLang)
   optContractDateGreg.Caption = frmJuristicNonResidentCaption(4, UserLang)
   lblContractIssueDate.Caption = frmJuristicNonResidentCaption(5, UserLang)
   lblContractExpiryDate.Caption = frmJuristicNonResidentCaption(6, UserLang)
   lblSamaAuthNo.Caption = frmJuristicNonResidentCaption(33, UserLang)
   lblSamaAuthDateType.Caption = frmJuristicNonResidentCaption(2, UserLang)
   optSamaAuthDateHijri.Caption = frmJuristicNonResidentCaption(3, UserLang)
   optSamaAuthDateGreg.Caption = frmJuristicNonResidentCaption(4, UserLang)
   lblSamaAuthIssueDate.Caption = frmJuristicNonResidentCaption(5, UserLang)
   lblSamaAuthExpiryDate.Caption = frmJuristicNonResidentCaption(6, UserLang)
   lblLicNo.Caption = frmJuristicNonResidentCaption(34, UserLang)
   lblLicDateType.Caption = frmJuristicNonResidentCaption(2, UserLang)
   optLicDateHijri.Caption = frmJuristicNonResidentCaption(3, UserLang)
   optLicDateGreg.Caption = frmJuristicNonResidentCaption(4, UserLang)
   lblLicIssueDate.Caption = frmJuristicNonResidentCaption(5, UserLang)
   lblLicExpiryDate.Caption = frmJuristicNonResidentCaption(6, UserLang)
   lblLangPreferred.Caption = frmJuristicNonResidentCaption(7, UserLang)
   optLangArabic.Caption = frmJuristicNonResidentCaption(8, UserLang)
   optLangEnglish.Caption = frmJuristicNonResidentCaption(9, UserLang)
   lblNationality.Caption = frmJuristicNonResidentCaption(10, UserLang)
   lblBusinessType.Caption = frmJuristicNonResidentCaption(11, UserLang)
   lblFirstName.Caption = frmJuristicNonResidentCaption(12, UserLang)
   lbl2ndName.Caption = frmJuristicNonResidentCaption(13, UserLang)
   lblShortName.Caption = frmJuristicNonResidentCaption(14, UserLang)
   lblArabicName.Caption = frmJuristicNonResidentCaption(15, UserLang)
   lblEnglishName.Caption = frmJuristicNonResidentCaption(16, UserLang)
   lblOrgAlphaSearch.Caption = frmJuristicNonResidentCaption(35, UserLang)
   lblPurposeOfAccount.Caption = frmJuristicNonResidentCaption(17, UserLang)
   lblAddress1.Caption = frmJuristicNonResidentCaption(18, UserLang)
   lblPOBox.Caption = frmJuristicNonResidentCaption(19, UserLang)
   lblCity.Caption = frmJuristicNonResidentCaption(20, UserLang)
   lblZipCode.Caption = frmJuristicNonResidentCaption(21, UserLang)
   lblCountry.Caption = frmJuristicNonResidentCaption(22, UserLang)
   lblOffPhone.Caption = frmJuristicNonResidentCaption(23, UserLang)
   lblResPhone.Caption = frmJuristicNonResidentCaption(24, UserLang)
   lblFax.Caption = frmJuristicNonResidentCaption(25, UserLang)
   lblMobile.Caption = frmJuristicNonResidentCaption(26, UserLang)
   lblPager.Caption = frmJuristicNonResidentCaption(27, UserLang)
   lblEmail.Caption = frmJuristicNonResidentCaption(28, UserLang)
   cmdAcctInfo.Caption = frmJuristicNonResidentCaption(29, UserLang)
   cmdSupervisorComments.Caption = frmJuristicNonResidentCaption(30, UserLang)
   cmdNextPage.Caption = frmJuristicNonResidentCaption(31, UserLang)
   cmdCancel.Caption = frmJuristicNonResidentCaption(32, UserLang)
   
   lblApproverNumber.Caption = frmJuristicNonResidentCaption(36, UserLang)
   lblApproverName.Caption = frmJuristicNonResidentCaption(37, UserLang)
   lblAppDateType.Caption = frmJuristicNonResidentCaption(2, UserLang)
   optAppDateHijri.Caption = frmJuristicNonResidentCaption(3, UserLang)
   optAppDateGreg.Caption = frmJuristicNonResidentCaption(4, UserLang)
   lblAppIssueDate.Caption = frmJuristicNonResidentCaption(5, UserLang)
   lblAppExpiryDate.Caption = frmJuristicNonResidentCaption(6, UserLang)
   ...
   txtSysDate.text = Date
    ...
    cmbContractIssueDate.Clear
    cmbContractIssueMonth.Clear
    cmbContractExpiryDate.Clear
    cmbContractExpiryMonth.Clear
    ...
    For i = 1 To 30
       ...
       Else
          num = CStr(i)
       End If
       cmbContractIssueDate.AddItem num
       cmbSamaAuthIssueDate.AddItem num
       cmbContractExpiryDate.AddItem num
       ...
       If i < 13 Then
          cmbContractIssueMonth.AddItem num
          cmbSamaAuthIssueMonth.AddItem num
          cmbContractExpiryMonth.AddItem num
   ...
   If supervisorAction Or searchAction Or custHistoryAction Then
      ...
      FrameContractInfo.Enabled = False
      FrameSamaAuthInfo.Enabled = False
      FrameLicInfo.Enabled = False
   ...
   Else
      ...
      FrameContractInfo.Enabled = True
      FrameSamaAuthInfo.Enabled = True
      FrameLicInfo.Enabled = True
...
Private Sub FrameContractInfo_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
    secsUserInactive = 0
    CSD_mdiForm.staticStatus.Panels(5).text = secsUserInactive
End Sub
...
Private Sub FrameLicInfo_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
    secsUserInactive = 0
    CSD_mdiForm.staticStatus.Panels(5).text = secsUserInactive
End Sub
...
Private Sub FrameSamaAuthInfo_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
    secsUserInactive = 0
    CSD_mdiForm.staticStatus.Panels(5).text = secsUserInactive
End Sub
...
Private Sub optContractDateGreg_Click()
   If cmbContractIssueDate.ListCount = 30 Then
      cmbContractIssueDate.AddItem 31
      cmbContractExpiryDate.AddItem 31
   End If
   cmbContractIssueDate = ""
   cmbContractIssueMonth = ""
   txtContractIssueYear = ""
   cmbContractExpiryDate = ""
   cmbContractExpiryMonth = ""
   txtContractExpiryYear = ""
End Sub

Private Sub optContractDateHijri_Click()
   If cmbContractIssueDate.ListCount = 31 Then
      cmbContractIssueDate.RemoveItem 30
      cmbContractExpiryDate.RemoveItem 30
   End If
   cmbContractIssueDate = ""
   cmbContractIssueMonth = ""
   txtContractIssueYear = ""
...
Private Sub txtContractExpiryYear_Change()
  If Not supervisorAction And Not searchAction And Not custHistoryAction Then
     On Error Resume Next
     If Len(RTrim(txtContractExpiryYear)) <> 0 Then
        If Len(txtContractExpiryYear) = 4 Then
...
Private Sub txtContractExpiryYear_LostFocus()
If Not supervisorAction And Not searchAction And Not custHistoryAction Then
    If Screen.ActiveControl.Name = "cmdCancel" Then
       DoEvents
    Else
       If Len(RTrim(cmbContractExpiryDate)) > 0 And Len(RTrim(cmbContractExpiryMonth)) > 0 Then
          If Len(RTrim(txtContractExpiryYear)) <> 4 Then
             MsgBox errEnterValidYear(UserLang)
             txtContractExpiryYear.text = ""
             txtContractExpiryYear.SetFocus
             Exit Sub
          End If
       End If
       On Error Resume Next
       If Len(RTrim(txtContractExpiryYear)) <> 0 Then
          If optContractDateHijri.Value = True Then
             If txtContractExpiryYear > 1600 Then
                MsgBox errEnterValidYear(UserLang) '"Enter a valid Year"
                If txtContractExpiryYear.Enabled = True Then
                   txtContractExpiryYear.text = ""
                   txtContractExpiryYear.SetFocus
                Else
                   'framecrInfo.Enabled = True
                   txtContractExpiryYear.Enabled = True
                   txtContractExpiryYear.text = ""
                   txtContractExpiryYear.SetFocus
                End If
             End If
...
Private Sub txtContractIssueYear_Change()
  If Not supervisorAction And Not searchAction And Not custHistoryAction Then
     On Error Resume Next
     If Len(RTrim(txtContractIssueYear)) <> 0 Then
        If Len(txtContractIssueYear) = 4 Then
           cmbContractExpiryDate.SetFocus
        End If
     End If
     On Error GoTo 0
...
Private Sub txtContractIssueYear_KeyPress(KeyAscii As Integer)
If (KeyAscii < 48 Or KeyAscii > 57) And KeyAscii <> 8 Then
      KeyAscii = 0
      MsgBox (errOnlyNumeralsAllowed(UserLang))
      Exit Sub
...
Private Sub txtContractIssueYear_LostFocus()
 If Not supervisorAction And Not searchAction And Not custHistoryAction Then
    If Screen.ActiveControl.Name = "cmdCancel" Then
       DoEvents
    Else
       If Len(RTrim(cmbContractIssueDate)) > 0 And Len(RTrim(cmbContractIssueMonth)) > 0 Then
          If Len(RTrim(txtContractIssueYear)) <> 4 Then
             MsgBox errEnterValidYear(UserLang)
             txtContractIssueYear.text = ""
             txtContractIssueYear.SetFocus
             Exit Sub
          End If
       End If
       ...
       If Len(RTrim(txtContractIssueYear)) <> 0 Then
          If optContractDateHijri.Value = True Then
             If txtContractIssueYear > 1600 Then
                MsgBox errEnterValidYear(UserLang) '"Enter a valid Year"
                If txtContractIssueYear.Enabled = True Then
                   txtContractIssueYear.text = ""
                   txtContractIssueYear.SetFocus
                Else
                   txtContractIssueYear.Enabled = True
                   txtContractIssueYear.text = ""
                   txtContractIssueYear.SetFocus
                End If
             End If
...
Public Function validateFrmJuristicNonResident() As Integer
    ...
    If subCategoryCode = "46" Or subCategoryCode = "47" Then
        If Len(RTrim(txtContractNo)) = 0 Then
           MsgBox errSpaceContract(UserLang)
         ...
         Else
           validateFrmJuristicNonResident = 0
         End If
     End If ' subcategorycode = "46" or subcategorycode = "47"
    
     If Len(RTrim(txtContractNo)) > 0 Then
         If Len(RTrim(cmbContractIssueDate.text)) = 0 Or _
            Len(RTrim(cmbContractIssueMonth.text)) = 0 Or _
            Len(RTrim(txtContractIssueYear.text)) = 0 Then
        ...
        Else
            validateFrmJuristicNonResident = 0
        End If
        If Len(RTrim(cmbContractExpiryDate.text)) = 0 Or _
           Len(RTrim(cmbContractExpiryMonth.text)) = 0 Or _
           Len(RTrim(txtContractExpiryYear)) = 0 Then
        ...
        tIssueDate = CStr(txtContractIssueYear) & _
                     CStr(cmbContractIssueMonth.text) & _
                     CStr(cmbContractIssueDate.text)
             
        tExpiryDate = CStr(txtContractExpiryYear) & _
                      CStr(cmbContractExpiryMonth.text) & _
                      CStr(cmbContractExpiryDate.text)
                              
          If optContractDateGreg.Value = True Then
         ...
         If optContractDateHijri = True Then
        ...
        Else
           ...
           End If
        End If
     End If ' if len(contractnumber) > 0
   
'   If subCategorycode = "48" Or _
'      subCategorycode = "49" Or subCategorycode = "51" Or _
'      subCategorycode = "44" Then
'
'      If Len(RTrim(txtSamaAuthNo)) = 0 Then
...
'       End If
       ...
       If Len(RTrim(tExpiryDate)) <> 0 Then
            ...
            If optSamaAuthDateHijri = True Then
             ...
             End If
        End If
   'End If ' subcategorycode = 44 or 48 or 49 or 51
