...
const AR_EXTRA: Record<string, string> = {
  ...
  'download excel': 'تنزيل إكسل',
  'download this statement as an excel workbook': 'تنزيل كشف الحساب كملف إكسل',
  'dr/cr': 'مدين/دائن',
  ...
  'statement downloaded — {txns} transactions': 'تم تنزيل كشف الحساب — {txns} حركة',
