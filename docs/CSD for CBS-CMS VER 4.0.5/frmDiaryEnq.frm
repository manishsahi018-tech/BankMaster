...
Begin VB.Form frmDiaryEnq 
   BackColor       =   &H00BFD87E&
   Caption         =   "Diary Enquiry"
   ClientHeight    =   3195
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4680
   ...
   Begin VB.Label lblAcctNo 
      ...
      Width           =   2055
   End
   Begin VB.Label lblDiaryInfomation 
      BackColor       =   &H00BFD87E&
      Caption         =   "Diary Detail Enquiry"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   18
         Charset         =   178
...
Private Sub Form_Load()
    ...
    If UserLang = ARABIC Then
       ChangePositions frmDiaryEnq, 11800
       frmDiaryEnq.RightToLeft = True
       frmDiaryEnq.Hide
    End If
       
'   frmDiaryEnq.lblAcctNo.Caption = frmAcctStatusHistoryCaption(1, UserLang)
