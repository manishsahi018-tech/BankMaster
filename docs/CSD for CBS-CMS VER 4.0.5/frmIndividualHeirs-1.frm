...
Begin VB.Form frmIndividualHeirs 
   BackColor       =   &H00BFD87E&
   Caption         =   "Individual Saudi Heirs Customer Details"
   ClientHeight    =   8370
   ClientLeft      =   60
   ClientTop       =   3090
   ClientWidth     =   11805
   ...
   Begin VB.Frame frameSamaAuthInfo 
      ...
      Begin VB.Label lblSamaAuthIssueDate 
         ...
         Width           =   585
      End
      Begin VB.Label lblSuccDeedNo 
         AutoSize        =   -1  'True
         BackColor       =   &H00BFD87E&
         Caption         =   "Succ Deed No."
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   178
...
Public Function validateIndividualSaudi() As Integer
   ...
   ' CHECKING FOR SAUDI UNDER SPECIAL CIRCUMSTANCES STARTS HERE
    ...
    If subCategoryCode = "02" Or subCategoryCode = "59" Or _
       subCategoryCode = "73" Or subCategoryCode = "69" Then
