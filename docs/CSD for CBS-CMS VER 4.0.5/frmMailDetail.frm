...
Private Sub cmdCallCentreAction_Click()
   'Unload Me
'   Unload frmReturnMailPendingList
'   frmReturnMailPendingList.tag = "C"  ' Call centre pending list
...
Private Sub cmdGetDetails_Click()
    ...
    If Len(RTrim(txtRefNo)) <> 16 Then
       MsgBox errInvalidRefNo(UserLang)
       txtRefNo.SetFocus
       Exit Sub
    End If
...
Private Sub cmdRegister_Click()
   ...
   Dim i As Integer
    ...
    For i = 0 To Screen.ActiveForm.Controls.Count - 1
        ...
        End If
        If TypeOf Screen.ActiveForm.Controls(i) Is ComboBox Then
